...
def get_user_backups_ref(user_id):
    ...
    if db:
        # Исправленный синтаксис путей согласно правилам Firestore в Python:
        # Собираем путь через подколлекции: artifacts -> {app_id} -> public_data -> backups_{user_id}
